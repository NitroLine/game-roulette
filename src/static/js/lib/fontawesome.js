...
!(function(t) {
    ...
    function n(t, e) {
        ...
        if (Object.getOwnPropertySymbols) {
            ...
            e && (o = o.filter(e => Object.getOwnPropertyDescriptor(t, e).enumerable)), n.push.apply(n, o);
        }
    ...
    function c(t, e) {
        const n = e && e.addOn || "";
        const o = e && e.baseFilename || t.license + n;
        const r = e && e.minify ? ".min" : "";
        const i = e && e.fileSuffix || t.method;
        const c = e && e.subdir || t.method;
        return `${t.baseUrl}/releases/${t.version === "latest" ? "latest" : "v".concat(t.version)}/${c}/${o}${r}.${i}`;
    }
    ...
    function u(t, e) {
        const n = e || ["fa"];
        const o = `.${Array.prototype.join.call(n, ",.")}`;
    ...
    const d = typeof global !== "undefined" && void 0 !== global.process && typeof global.process.emit === "function";
    ...
    function F(t, e) {
        ...
        const r = e.token;
        let i = t;
        return "URLSearchParams" in window ? (i = new URL(t)).searchParams.set("token", r) : i = `${i}?token=${encodeURIComponent(r)}`, i = i.toString(), new _((t, e) => {
    ...
    function C(t, e) {
        ...
        var r = e.document || r;
        const i = u.bind(u, r, ["fa", "fab", "fas", "far", "fal", "fad", "fak"]);
    ...
    function U(t, e) {
        ...
        const r = document.createTextNode(n(t, e));
    ...
    function k(t, e) {
        e.autoA11y = t.autoA11y.enabled, t.license === "pro" && (e.autoFetchSvg = !0, e.fetchSvgFrom = `${t.baseUrl}/releases/${t.version === "latest" ? "latest" : "v".concat(t.version)}/svgs`, e.fetchUploadedSvgFrom = t.uploadsUrl);
        const n = [];
        return t.v4shim.enabled && n.push(new _((n, r) => {
            F(c(t, {
                addOn: "-v4-shims",
                minify: t.minify.enabled
            }), e).then(t => {
            ...
            F(c(t, { minify: t.minify.enabled }), e).then(t => {
                ...
                n((function(t, e) {
                    ...
                    const o = e && void 0 !== e.autoA11y ? e.autoA11y : void 0;
    ...
    function L(t) {
        ...
        const n = [];
        const o = document;
        const r = o.documentElement.doScroll;
    ...
    function T(t) {
        typeof MutationObserver !== "undefined" && new MutationObserver(t).observe(document, {
            childList: !0,
            subtree: !0
        });
    }
    ...
    try {
        if (window.FontAwesomeKitConfig) {
            ...
            (function() {
                ...
                return t.method === "js" ? k(t, e) : t.method === "css" ? C(t, e, t => {
                    L(t), T(t);
                }) : void 0;
            })(x, M).then(t => {
                t.map(t => {
